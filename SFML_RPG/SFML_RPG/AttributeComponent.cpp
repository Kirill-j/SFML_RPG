...
{
	this->hpMax			= this->vitality * 5 + this->vitality + this->strenght / 2 + this->intelligence / 5;
	this->damageMax		= this->strenght * 2 + this->strenght / 4 + this->intelligence / 5;
	this->damageMax		= this->strenght * 2 + this->strenght / 3 + this->intelligence / 5;

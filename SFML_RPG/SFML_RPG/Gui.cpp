...
{
	/*
	 * Convert a percentage value to pixels relative to current resolution in the x-axis.
	 *
...
{
	/*
	 * Convert a percentage value to pixels relative to current resolution in the y-axis.
	 *
	 * @param       float perc					The percentage value.
	 * @param       sf::VideoMode& vm           The curren videomode of the window (resolution).
	 * 
	...
	: font(font), showList(false), keytimeMax(1.f), keytime(0.f)
{
	...
	this->activeElement = new gui::Button(
		...
		sf::Color(70, 70, 70, 200), sf::Color(20, 20, 20, 200), sf::Color(150, 150, 150, 200),
		sf::Color(255, 255, 255, 200), sf::Color(255, 255, 255, 255), sf::Color(150, 150, 150, 200)
	);
	...
	for (unsigned i = 0; i < nrOfElements; i++)
	{
		this->list.push_back(
			new gui::Button(
				...
				sf::Color(70, 70, 70, 200), sf::Color(20, 20, 20, 200), sf::Color(150, 150, 150, 200),
				sf::Color(255, 255, 255, 0), sf::Color(255, 255, 255, 0), sf::Color(150, 150, 150, 0),
				i
			)
		);
	}
